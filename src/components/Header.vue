<template>
  <div>
    <el-menu background-color="#2e2e2e" text-color="#ffffff" active-text-color="#000000" class="el-menu-demo" mode="horizontal" @select="handleSelect" router>
        <el-menu-item index="/index"><el-avatar :size="50" :src="require('../assets/images/header/lambda1.webp')"></el-avatar>&nbsp;主页
        </el-menu-item>
        <el-menu-item index="/playag">PlayAG</el-menu-item>
        ...
        <el-submenu index="/demovideo" text-color="#ffffff">
          <template slot="title">DEMO视频</template>
