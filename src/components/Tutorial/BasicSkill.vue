  ...
  <div>
    <el-card class="box-card">
      <div slot="header">
        ...
        <p class="text item">
          在AG中，<span style="font-weight: bold;">真正的手无寸铁并不是只拿一把小手枪和撬棍，而是对游戏操作的一无所知。</span>
          因此我们经常可以看见两个FPS基础相近的玩家在比赛中都能拉开很大差距，就是因为对游戏技巧的掌握程度不同。所以，请认真学习和练习，将你自己武装起来吧！
        </p>
        <p class="text item">
      ...
      <div id="skillnav">
        <el-menu default-active="/basicskill/headshot" @open="handleOpen" @close="handleClose" router>
        ...
        <div id="skilldescription">
          <router-view name="basicskill"></router-view>
        </div>
      </div>
    </el-card>
